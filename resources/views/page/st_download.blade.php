            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a class="text-primary"
                            href="{{ url('st_download/1')}}">บริการข้อมูล</a></li>
        ...
        <div class="col-md-3">
            ...
            <div class="card mb-3">
                <div class="card-header gradient-card-header peach-gradient">
                    <h5 class="text-right">บริการข้อมูลนักศึกษา11</h5>
                </div>
                <div class="list-group list-group-flush">
                    @foreach ($ListTypeDoc as $Types)
                    <a href="{{ url("st_download/$Types->id")}}" class="list-group-item list-group-item-action"><i
