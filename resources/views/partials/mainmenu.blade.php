<ul class="navbar-nav ml-auto mt-2 mt-lg-0">
     ...
     <li class="nav-item">
         <a class="nav-link" href="{{ url('page/about')}}">เกี่ยวกับเรา</a>
     </li>
     {{--  <li class="nav-item">
         <a class="nav-link text-primary" href="#">สาขาวิชา</a>
     </li> --}}
     <li class="nav-item">
    ...
    {{--  <li class="nav-item">
     ...
     <li class="nav-item">
     <a class="nav-link" href="{{ url('academic')}}" target="_blank">งานวิชาการ</a>
    </li>
 </ul>
