    ...
    <div class="container">
        <div class="columns">
            <div class="column is-3 is-offset-2">
                <ul>
                    <li><a href="#">สำนักนวัตกรรมและการศึกษาต่อเนื่อง</a></li>
                   {{--  <li><a href="#"></a></li> --}}
...
{{--                 <h2><strong>Category</strong></h2>
 --}}                <ul>
                    <li><a href="#">สมาคมสหกิจศึกษาไทย</a></li>
        ...
        <div class="content has-text-centered">
            <div class="control level-item">
                <a href="https://social.crru.ac.th">
                    <div class="tags has-addons">
                        <span class="tag is-dark">สำนักวิชาสังคมศาสตร์</span>
                        <span class="tag is-info">มหาวิทยาลัยราชภัฏเชียงราย</span>
                    </div>
                </a>
            </div>
        </div>
